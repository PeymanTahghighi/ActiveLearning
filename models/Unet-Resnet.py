...
class Upblock(nn.Module):
    def __init__(self, in_features, out_features) -> None:
        ...
        self.conv1 = ConvBlock(in_channels=out_features*2, out_channels=out_features, kernel_size=3, stride=1);
...
class Unet(nn.Module):
    ...
    def forward(self, x):
        ...
        u_4 = self.up_4(torch.cat([u_3, d_1], dim=1));
        u_5 = self.up_5(torch.cat([u_4, x], dim=1));
